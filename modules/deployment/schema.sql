-- Deployment module schema
-- Run once when installing the deployment module into a Trongate project.
...
CREATE TABLE IF NOT EXISTS `deployment` (
    ...
    `status`                ENUM('pending','script_ready','queued','running','staged','success','failed') DEFAULT 'pending',
    `release_path`          VARCHAR(500) DEFAULT NULL,
    `previous_release_path` VARCHAR(500) DEFAULT NULL,
